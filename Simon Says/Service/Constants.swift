...
struct K {
	...
	struct UI {
		...
		struct ButtonsColor {
			...
			static let topNormal = UIColor(red: 124/255, green: 244/255, blue: 90/255, alpha: 0.2)
			
			static let leftSelected = UIColor(red: 242/255, green: 244/255, blue: 90/255, alpha: 1)
			static let leftNormal = UIColor(red: 242/255, green: 244/255, blue: 90/255, alpha: 0.2)
			
			static let rightSelected = UIColor(red: 90/255, green: 144/255, blue: 244/255, alpha: 1)
			static let rightNormal = UIColor(red: 90/255, green: 144/255, blue: 244/255, alpha: 0.2)
			
			static let bottomSelected = UIColor(red: 243/255, green: 108/255, blue: 70/255, alpha: 1)
			static let bottomNormal = UIColor(red: 243/255, green: 108/255, blue: 70/255, alpha: 0.2)
		}
